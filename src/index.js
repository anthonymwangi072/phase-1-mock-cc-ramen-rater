...
// Initial render to get data and append to the DOM
const init = () => getData();
...
// Function to render each menu items and populate the website
function renderOneData(item) {
...
// Populate detail section when image is clicked
...
// Adding a ramen menu through the submit form
